...
func NewWriter(lg *zap.Logger, externalStorage storeapi.Storage, cfg WriterCfg) (io.WriteCloser, error) {
...
func NewReader(lg *zap.Logger, storage storeapi.Storage, cfg ReaderCfg) (*loader, error) {
